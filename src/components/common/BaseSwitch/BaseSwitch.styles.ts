...
export const Switch = styled(AntdSwitch)`
  ...
  /* Network toggle styling - matches USD emerald green styling */
  &.liquid-switch.networkSwitch {
    position: relative;
    overflow: visible;
    border-radius: 100px;
    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    ...
    /* Liquid glass handle/knob - neutral styling */
    .ant-switch-handle {
      width: 18px !important;
      height: 18px !important;
      background: linear-gradient(135deg,
        rgba(255, 255, 255, 0.95) 0%,
        rgba(240, 240, 240, 0.90) 100% /* Neutral white */
      ) !important;
      border: 1px solid rgba(150, 150, 150, 0.3);
      border-radius: 50%;
      box-shadow:
        0 2px 8px rgba(150, 150, 150, 0.2),
        0 0 20px rgba(150, 150, 150, 0.1),
        inset 0 1px 2px rgba(255, 255, 255, 0.8);
      transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
      position: absolute !important;
      top: 0px !important;  /* Centered positioning */
      inset-inline-start: 2px !important;
    ...
    /* Unchecked state - dull/off appearance (no colors) */
    &.ant-switch[aria-checked='false'] {
      background: linear-gradient(135deg,
      ...
      box-shadow:
        ...
        0 0 10px rgba(150, 150, 150, 0.05);
    }
    
    /* Checked state - MATCHES USD EMERALD GREEN STYLING */
    &.ant-switch-checked {
      background: linear-gradient(to bottom right,
        rgba(16, 185, 129, 0.35), /* Emerald green for USD */
        rgba(52, 211, 153, 0.30),
        rgba(34, 197, 94, 0.35)
      ) !important;
      border: 2px solid rgba(52, 211, 153, 0.40);
      ...
      /* Shimmer overlay for green state */
      &::after {
        content: '';
        position: absolute;
        top: 0;
      ...
      .ant-switch-handle {
        ...
        background: linear-gradient(135deg,
          rgba(255, 255, 255, 1) 0%,
          rgba(236, 253, 245, 1) 100% /* Green-tinted for USD match */
        ) !important;
        border: 1px solid rgba(52, 211, 153, 0.5);
        box-shadow:
          0 4px 15px rgba(16, 185, 129, 0.6),
    ...
    &:not(.ant-switch-checked):hover {
      ...
      border-color: rgba(170, 170, 170, 0.20);
      
      .ant-switch-handle {
        box-shadow:
          0 3px 10px rgba(150, 150, 150, 0.3),
          0 0 25px rgba(150, 150, 150, 0.15),
          inset 0 1px 3px rgba(255, 255, 255, 0.9);
      }
    }
